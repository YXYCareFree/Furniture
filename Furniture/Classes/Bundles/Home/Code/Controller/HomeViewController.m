...
- (void)viewWillAppear:(BOOL)animated{
    ...
    CGRect frame = CGRectMake(0, 20, kScreenWidth, 44);
    [bar setFrame:frame];
}
...
- (void)setupView{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight - 49 - 65) style:UITableViewStylePlain];
...
- (void)setStaticGuidePage {
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:BOOLFORKEY]) {
        ...
        NSArray *imageNameArray = @[@"Guide1",@"Guide2",@"Guide3"];
