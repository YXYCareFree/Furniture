...
//    UnityIsOrientationEnabled(UIInterfaceOrientationPortrait);
//    UnityIsOrientationEnabled(UIInterfaceOrientationLandscapeRight);

    [[AlvaTool sharedInstance] getUnityWindow].backgroundColor = [UIColor whiteColor];

    [[AlvaTool sharedInstance] getUnityView].backgroundColor = [UIColor whiteColor];

    [AlvaTool sharedInstance].unityDefaultVC = [MainTabBarViewController new];
    [[AlvaTool sharedInstance] showUnityWindow];
